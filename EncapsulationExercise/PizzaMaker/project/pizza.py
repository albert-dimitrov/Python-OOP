from OOP.EncapsulationExercise.PizzaMaker.project.topping import Topping
from OOP.EncapsulationExercise.PizzaMaker.project.dough import Dough
...
class Pizza:
    ...
    def calculate_total_weight(self):
        ...
        total_weight += sum([t for t in self.toppings.values()])
